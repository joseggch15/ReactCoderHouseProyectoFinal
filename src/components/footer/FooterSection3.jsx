                ...
                <div className="row gy-5 justify-content-center justify-content-xxl-between">
                    <div className="col-xxl-2 col-xl-3 col-lg-3 col-md-4 col-6 col-xxs-12">
                        <div className="fz-3-footer__contact-info">
                            ...
                            <ul>
                                <li>
                                    <Link href="#"><i className="fa-light fa-location-dot"></i> 123456789</Link>
                                </li>
                                <li>
                                    <Link href="#"><i className="fa-light fa-phone"></i> 1234567</Link>
                                </li>
                                <li>
                                    <Link href="#"><i className="fa-light fa-envelope-open-text"></i> info@gmail.com</Link>
                                </li>
                            </ul>
                        </div>
                    </div>
